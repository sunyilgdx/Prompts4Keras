...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description='Run NSP-BERT classification for few-shot or zero-shot.')
    # About datasets
    ...
    parser.add_argument("--temperature", type=float, help="Temperature used in contrastive loss, usually 20.")
    parser.add_argument("--batch_size", type=int, default=8, help="Batch size.")
    parser.add_argument("--predict_batch_size", type=int, default=32, help="Batch size while predicting.")
    parser.add_argument("--loss_function", type=str, default='BCE', choices=['BCE', 'Contrastive', 'softmax'],
